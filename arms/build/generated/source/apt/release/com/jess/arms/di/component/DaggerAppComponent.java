...
public final class DaggerAppComponent implements AppComponent {
  ...
  private void initialize(final Builder builder) {
    ...
    this.provideCacheFactoryProvider =
        DoubleCheck.provider(
            GlobalConfigModule_ProvideCacheFactoryFactory.create(builder.globalConfigModule));
    ...
    this.provideExtrasProvider =
        DoubleCheck.provider(
            AppModule_ProvideExtrasFactory.create(builder.appModule, provideCacheFactoryProvider));
    ...
    this.activityLifecycleForRxLifecycleProvider =
        DoubleCheck.provider(ActivityLifecycleForRxLifecycle_Factory.create());

    this.appDelegateMembersInjector =
        AppDelegate_MembersInjector.create(
            activityLifecycleProvider, activityLifecycleForRxLifecycleProvider);
  }
